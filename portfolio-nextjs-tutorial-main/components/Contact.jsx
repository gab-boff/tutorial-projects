            ...
            <div className="lg:p-4 h-full">
              <div>
                <img
                  ...
                  src="https://thumbs.dreamstime.com/b/young-man-working-laptop-mobile-phone-table-closeup-124435100.jpg"
                  alt=""
                />
              </div>
              <div>
                <h2 className="py-2">Gabriel Boff</h2>
              ...
              <div>
                <p className="uppercase pt-8">Entre em contato comigo</p>
